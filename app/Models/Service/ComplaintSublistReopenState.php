...
class ComplaintSublistReopenState extends Model
{
    protected 	$guarded = [];
    protected 	$table = 'services_complaint_sublist_reopen_state';
    ...
    public static function initState($sub_id, $level)
    {
        ...
        $sub_state = new ComplaintSublistReopenState();
        ...
        // calculate end time
        $escalation = DB::table('services_complaint_sublist_reopen_escalation')            
