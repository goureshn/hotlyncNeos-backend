...
class TaxController extends Controller
{
    public function index(Request $request)
    {
		...
		return view('backoffice.wizard.call.tax', compact('tax', 'carrier', 'step'));			
    }
	
	public function getGridData()
    {
		$datalist = DB::table('call_tax as tax')			
						->leftJoin('call_carrier as cr', 'tax.carrier_id', '=', 'cr.id')		
						->select(['tax.*', 'cr.carrier']);
