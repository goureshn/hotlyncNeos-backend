...
class PartGroupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $partgroup = DB::table('eng_part_group as eg')
        ...
        return view('backoffice.wizard.engineering.partgroup', compact('name', 'description', 'code'));
    }

    public function getGridData()
    {
        $datalist = DB::table('eng_part_group as eg')
            ->select(['eg.*']);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $model = EquipmentPartGroup::create($input);
    ...
    {
        $model = EquipmentPartGroup::find($id);
    ...
    public function getPartGroupList(Request $request, $id)
    {
        if( $id > 0 )
        {
            $model = DB::table('eng_part_group')->where('dept_id', $id)->get();
        }
        else
        {
            $model = DB::table('eng_part_group')->get();
        }
