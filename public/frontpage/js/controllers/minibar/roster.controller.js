app.controller('MinibarRosterController', function ($scope, $rootScope, $http, $window, $uibModal, $timeout, $q, AuthService, toaster) {
    ...
    $scope.pageChanged = function () {
        ...
        $http({
            method: 'POST',
            url: '/frontend/guestservice/rosterlist_minibar',
            data: request,
