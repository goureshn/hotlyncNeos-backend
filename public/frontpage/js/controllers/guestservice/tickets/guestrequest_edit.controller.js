app.controller('GuestrequestEditController', function ($scope, $rootScope, $http, $interval, toaster, $uibModal,  GuestService, AuthService, $filter) {
    $scope.guest = {};
    ...
    var ASSIGN = 'Assign';
    var SCHEDULED_ACTION = 'Re-schedule';
    ...
    $scope.onReassign = function () {
       ...
       // window.alert(JSON.stringify($scope.task.reassign))
    ...
    $scope.onUpdateTime = function () {
        ...
        data.until_checkout_flag = $scope.task.until_checkout_flag ? 1 : 0;
...
app.controller('FeedBackModalCtrl', function ($scope, $rootScope, $http, AuthService, GuestService, $interval, toaster, $timeout, $uibModalInstance, task, feedback_flag) {
    /*
               $scope.ok = function () {
