app.controller('TaskgroupCreateController', function ($scope, $http, AuthService, toaster, $uibModalInstance, $uibModal) {
    ...
    $scope.model_data = {
        ...
        user_group: 0,
        max_time: 0,
        request_reminder: '50,80',
        frequency_notification_flag: false,
        freq_job_role_name_list: [],
        frequency: 0,
        period: 0,
        hold_notification_flag: false,
        hold_job_role_name_list: [],
        hold_timeout: "",
        unassigne_flag: false,
        start_duration: 0
    }
    ...
    $scope.onSave = function () {
        ...
        $http({
            method: 'POST',
            url: '/frontend/guestservice/addsettingtaskgroup',
            data: request,
