app.controller('RoomAssignmentController', function($scope, $rootScope, $http, $window, $uibModal, $timeout, $q, AuthService, toaster) {
    ...
    function getAttendantList() {
        ...
        $http({
            method: 'POST',
            url: '/frontend/hskp/attendantlist',
            data: request,
            headers: {'Content-Type': 'application/json; charset=utf-8'}
        })
            .then(function(response) {
    ...
    $scope.onSelectAttendant = function(row) {
        ...
        $http({
            method: 'POST',
            url: '/frontend/hskp/assignedroomlist',
            data: request,
            headers: {'Content-Type': 'application/json; charset=utf-8'}
        })
            .then(function(response) {
    ...
    $scope.onAssign = function() {
        ...
        for(var i = 0; i < $scope.models[1].items.length; i++ )
        {
         ...
         $http({
            method: 'POST',
            url: '/frontend/hskp/createroomassignment',
            data: request,
            headers: {'Content-Type': 'application/json; charset=utf-8'}
        })
            .then(function(response) {
    ...
    $scope.onAutoAssign = function() {
        ...
        $http({
            method: 'POST',
            url: '/frontend/hskp/assignroomwithauto',
            data: request,
            headers: {'Content-Type': 'application/json; charset=utf-8'}
        })
            .then(function(response) {
