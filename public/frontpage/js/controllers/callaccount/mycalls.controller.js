app.controller('MyCallsController', function ($scope, $rootScope, $http, $timeout, $uibModal, $window, $interval, toaster, AuthService) {
    ...
    for (var i = 0; i < permission.length; i++) {
        if ((permission[i].name).indexOf('app.callaccounting.') != -1) {
            ...
            //window.alert(name);
            if (name =='mycallsdashboard'|| name == 'myadmincalls' || name == 'mymobilecalls') {
