app.controller('MycallFinanceController', function ($scope, $rootScope, $http, $timeout, $uibModal, $window, $interval, toaster, AuthService) {
    ...
    $scope.getDataCallList = function(tableState) {
        ...
        $http({
            method: 'POST',
            url: '/frontend/callaccount/getmyadmincallsfromfinance',
            data: request,
            headers: {'Content-Type': 'application/json; charset=utf-8'}
        })
            .then(function(response) {
