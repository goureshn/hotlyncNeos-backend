    ...
    .config(
        [          '$stateProvider', '$urlRouterProvider', 'JQ_CONFIG', 'MODULE_CONFIG',
            function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
                ...
                $urlRouterProvider
                    .otherwise('/app/complaint/briefingmng');
                ...
                $stateProvider
					...
					.state('access.signin', {
                        ...
                        resolve: load( [
                            'briefing/js/controllers/briefingmng_signin.js',
                        ] )
                    })
                    .state('access.signup', {
                        url: '/signup',
                    ...
                    .state('app.complaint', {
                     ...
                     .state('app.complaint.briefing_mng', {
                        ...
                        resolve: load([
                            'toaster', 'dndLists', 'ngAside', 'smart-table', 'ui.jq', 'ui.bootstrap.datetimepicker',
