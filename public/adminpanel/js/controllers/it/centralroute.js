define(['app', 'datatables.net', 'datatables.net-bs', 'directives/directive'], 
	...
	app.controller('CenteralRouteCtrl', function ($scope, $compile, $timeout, $http, $window,FileUploader /*$location, $http, initScript */) {
		console.log("CenteralRouteCtrl reporting for duty.");
		...
		$scope.fields = ['ID', 'Category', 'Sub Category', 'Levels', 'Job Roles', 'Notify Types'];
		function initDomData() {
			var $grid = $('#table_grid').dataTable( {
				processing: true,
				serverSide: true,
				order: [[ 0, "asc" ]], //column indexes is zero based
				ajax: '/backoffice/it/wizard/approvallist?central_mode=1',
