define(['app', 'datatables.net', 'datatables.net-bs', 'directives/directive'],
    function (app) {
        app.controller('ModuleCtrl', function ($scope, $compile, $window, $timeout, $http /*$location, $http, initScript */) {
            ...
            /*
            $scope.modules = [
                {id: 'Call Accounting', name: 'Call Accounting'},
                {id: 'Call Centre', name: 'Call Centre'},
                {id: 'Complaint', name: 'Complaint'},
                {id: 'Engineering', name: 'Engineering'},
                {id: 'Guest Service', name: 'Guest Service'},
                {id: 'Housekeeping', name: 'Housekeeping'},
                {id: 'Minibar', name: 'Minibar'},
                {id: 'ETS Request Management', name: 'ETS Request Management'},
                {id: 'ETS Chat System', name: 'ETS Chat System'},
                {id: 'ETS Auto Wake Up Call', name: 'ETS Auto Wake Up Call'},
                {id: 'ETS Marketing', name: 'ETS Marketing'},
                {id: 'ETS Guest Survey', name: 'ETS Guest Survey'}
            ];
*/
            ...
            function initDomData() {
                var $grid = $('#table_grid').dataTable( {
                    ...
                    ajax: '/backoffice/property/wizard/module',
            ...
            $scope.onUpdateRow = function()
            {
                ...
                if($scope.model_data.name == '' || $scope.model_data.description == '') {
                    ...
                    if (id >= 0)	// Update
                    {
                        $http({
                            method: 'PUT',
                            url: '/backoffice/property/wizard/module/' + id,
                        ...
                        $http({
                            method: 'POST',
                            url: '/backoffice/property/wizard/module',
                            data: $scope.model_data,
                            headers: {'Content-Type': 'application/json; charset=utf-8'}
                        })
                            .success(function (data, status, headers, config) {
