define(['app', 'datatables.net', 'datatables.net-bs', 'directives/directive'],
    function (app) {
        ...
        app.controller('EquipGroupCtrl', function ($scope, $compile, $timeout, $window, $http /*$location, $http, initScript */) {
            ...
            $scope.menus = [
                ...
                {link: '/engineering/equipgroup', name: 'equipgroup'},
            ];
            ...
            function initDomData() {
                ...
                var $grid = $('#table_grid').dataTable( {
                    ...
                    ajax: '/backoffice/engineering/wizard/equipgroupnggrid/get',
            ...
            $scope.onUpdateRow = function()
            {
                ...
                if( id >= 0 )	// Update
                {
                    $http({
                        method: 'PUT',
                        url: '/backoffice/engineering/wizard/equipgroup/' + id,
                ...
                else
                {
                    $http({
                        method: 'POST',
                        url: '/backoffice/engineering/wizard/equipgroup',
                        data: $scope.model_data,
                        headers: {'Content-Type': 'application/json; charset=utf-8'}
                    })
                        .success(function(data, status, headers, config) {
            ...
            $scope.onDeleteRow = function(id)
            {
                if( id >= 0 )
                {
                    $http.get('/backoffice/engineering/wizard/equipgroup/' + id)
