    ...
    function (app) {
        ...
        app.controller('CategoryCtrl', function ($scope, $compile, $timeout, $window, $http /*$location, $http, initScript */) {
            ...
            $scope.menus = [
                ...
                {link: '/engineering/category', name: 'category'},
            ];
            ...
            $scope.fields = ['ID', 'Category Name', 'Property'];
            ...
            function initDomData() {
                ...
                var $grid = $('#table_grid').dataTable( {
                    ...
                    ajax: '/backoffice/engineering/wizard/categorynggrid/get',
                    "lengthMenu": [[15, 25, 50, 100, -1], [15, 25, 50, 100, "All"]],
                    columns: [
                        //{ data: 'checkbox', width: '40px', orderable: false, searchable: false},
                        { data: 'id', name: 'erc.id' },
                        { data: 'name', name: 'erc.name' },
