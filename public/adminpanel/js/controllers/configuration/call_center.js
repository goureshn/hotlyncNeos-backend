define(['app', 'datatables.net', 'datatables.net-bs', 'directives/directive'],
    function (app) {
        app.controller('CallCenterCtrl', function ($scope, $compile, $timeout, $http /*$location, $http, initScript */) {
            $scope.property_id = 0;
            ...
            $scope.displayCallCenter = function (data) {
                ...
                $scope.call_center.auto_wrapup_flag = $scope.call_center.auto_wrapup_flag == "1";
                $scope.call_center.caller_info_save_flag = $scope.call_center.caller_info_save_flag == "1";
                $scope.call_center.call_center_widget = $scope.call_center.call_center_widget == "1";
                $scope.call_center.softphone_enabled = $scope.call_center.softphone_enabled == "1";
            }
