<div style="margin-top: 5px">
    ...
    <b style="margin-bottom: 5px">Guest Grand Total By Building</b>
    ...
    <table class="" style="width : 100%">
        <tbody>
            <tr class="total-amount">
                ...
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->International, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->Local, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->Mobile, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->National, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->Toll, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->Total_Carrier, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->Total_Hotel, 2)}}</b></td>
                <td width=10% align="right";><b>{{$data['currency']}} {{number_format($data['guest_total_value']->Total, 2)}}</b></td>
            </tr>
        </tbody>
    </table>
</div>