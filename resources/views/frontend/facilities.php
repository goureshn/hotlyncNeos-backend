...
-->
  ...
  <!-- App -->
  <script src="facilities/js/facilities_app.js"></script>
  <script src="js/config.js"></script>
  <script src="js/config.lazyload.js"></script>
  <script src="facilities/js/facilities_config.router.js"></script>
  <script src="facilities/js/facilities_main.js"></script>
