...
<body ng-controller="AppCtrl" layout="row" ng-init="init('<?php echo base64_encode(json_encode($_REQUEST))?>')" style="font-size: inherit;">
...
<!-- build:js js/app.material.js -->
  ...
  <script src="guest/js/guest_config_simulator.router.js"></script>
