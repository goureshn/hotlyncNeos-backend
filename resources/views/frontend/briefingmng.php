...
-->
  ...
  <!-- App -->
  <script src="briefing/js/briefing_app.js"></script>
  <script src="js/config.js"></script>
  <script src="js/config.lazyload.js"></script>
  <script src="briefing/js/briefingmng_config.router.js"></script>
  <script src="briefing/js/briefingmng_main.js"></script>
