...
<?php	
	...
	$current_url = '/backoffice/user/wizard/pmgroup';	
	$param = "";
...
<div class="item_container" style="margin:auto;height:600px">
	<div class="items">		
		...
		<span class="delete-button"  style="float:right;margin-top:7px;margin-right:2px;background:#648CA9; border-radius:3px;border:1px solid;border-color:#ccc;">
			...
			<input type="button" class="arrow-del-button" value="Add" onclick="location.href = '/backoffice/user/wizard/pmgroup/create'" />
		</span>
	</div>		
...
<div class="bottom-button" style="clear:both;">
	<span class="button-style cm-process-items" style="width:90%;text-align:right;margin:auto;margin-top:10px;">
		<input type="button" class="arrow-button" onclick="location.href = '/backoffice/user/wizard/user';"  value="  Prev  " />
	</span>	&nbsp;&nbsp;&nbsp;&nbsp;
	<span class="button-style cm-process-items" style="width:90%;text-align:right;margin:auto;margin-top:10px;">
		<input type="button" class="arrow-button" onclick="location.href = '/backoffice/user/wizard/usergroup';"  value="  Next  " />
	</span>						
</div>
