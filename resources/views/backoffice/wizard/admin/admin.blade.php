...
<?php
	...
	$current_url = '/backoffice/admin/wizard/admin';
	$param = "";
		...
		<div style="margin-top:20px;text-align:center">
			...
			<div id="content_general" style="margin-top:40px;clear:left">
				<fieldset>
					...
					{{ Form::open(array('url' => '/backoffice/admin/wizard/admin/' . $model->id, 'method' => $method )) }}		
					<div class="form-field">
					...
					<div class="form-field">
						<label for="name" class="cm-required">Admin Area:</label>
...
<div class="bottom-button" style="clear:both;">
	<span class="button-style cm-process-items" style="width:90%;text-align:right;margin:auto;margin-top:10px;">
		<input type="button" class="arrow-button" onclick="location.href = '/backoffice/admin/wizard/common';" value="  Prev  " />
	</span>	&nbsp;&nbsp;&nbsp;&nbsp;
	<span class="button-style cm-process-items" style="width:90%;text-align:right;margin:auto;margin-top:10px;">
		<input type="button" class="arrow-button" onclick="location.href = '/backoffice/admin/wizard/outdoor';"  value="  Next  " />
	</span>						
</div>

<script type="text/javascript">
	var excelupload = {
        url: "/backoffice/admin/wizard/admin/upload",
        dragDrop: false,
        fileName: "myfile",
        multiple: false,
        showCancel: false,
