		...
		<div class="col-sm-offset-1 col-md-10"> 
			<div class="panel panel-primary"> 
				...
				<div class="panel-body"> 
					<table id="tax_grid" class="table table-hover table-bordered" style="text-align: center"> 
						<thead> 
							<tr> 
			...
			<div class="col-sm-offset-10">
				<button type="button" class="btn btn-warning btn-sm" onclick="location.href = '/backoffice/call/wizard/propertycharge'"> 
					<span class="glyphicon glyphicon-backward"></span><b> Back </b>
				</button>
					<button type="button" class="btn btn-success btn-sm" onclick="location.href = '/backoffice/call/wizard/allowance'"><b> Next </b>  
	...
	<div class="modal-dialog" role="document"> 
		<div class="modal-content"> 
			<div class="modal-header"> 
				...
				<h3 class="modal-title" style="color:#2691d9" id="addModalLabel">Add Tax</h3> 
			</div>                         
			<div class="modal-body"> 
				...
				<form class="form-horizontal"> 
					...
					<div class="form-group">
						<label class="control-label col-sm-4" for="client">Tax Name: </label>
						<div class="col-sm-5">
							<input type="text" class="form-control" id="name" placeholder="Name">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="client">Tax Value: </label>
						<div class="col-sm-5">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title" style="color:#2691d9" id="Heading">Delete Tax</h3>
			</div>
			<br>
			<div class="modal-body">
...
<script>
	...
	var $grid = $('#tax_grid').dataTable( {
		processing: true,
		serverSide: true,
		ajax: '/backoffice/call/wizard/taxgrid/get',
	...
	function onUpdateRow()
	{
		...
		if( id >= 0 )	// Update
		{
			$.ajax({
				type: "POST",
				url: "/backoffice/call/wizard/tax/updatedata",
				data: data,
				success:function(data){
		...
		{	
			...
			$.ajax({
				type: "POST",
				url: "/backoffice/call/wizard/tax/createdata",
				data: data,
				success:function(data){
					// $grid.fnDraw();
	...
	function  deleteRow()
	{
		...
		{
			$.ajax({
				url: "/backoffice/call/wizard/tax/delete/" + id,
				success:function(data){					
					refreshCurrentPage();					
				},			
				error:function(request,status,error){
