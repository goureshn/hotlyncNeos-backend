	...
	<div class="row"> 
		<div class="col-sm-offset-1 col-md-10"> 
			...
			<div class="col-sm-offset-10">
				...
				<button type="button" class="btn btn-success btn-sm" onclick="location.href = '/backoffice/call/wizard/timeslab'"><b> Next </b>  
	...
	<div class="modal-dialog" role="document"> 
		<div class="modal-content"> 
			<div class="modal-header"> 
				...
				<h3 class="modal-title" style="color:#2691d9" id="addModalLabel">Add Allowance</h3> 
			</div>                         
			<div class="modal-body"> 
				<br> 
				<form class="form-horizontal"> 
					<div class="form-group">
						<label class="control-label col-sm-4" for="client">Allowance Name: </label>
						<div class="col-sm-5">
							<input type="text" class="form-control" id="name" placeholder="Name">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="client">Allowance Duration: </label>
						<div class="col-sm-5">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title" style="color:#2691d9" id="Heading">Delete Allowance</h3>
			</div>
			<br>
			<div class="modal-body">
...
<script>
	...
	var $grid = $('#allowance_grid').dataTable( {
		processing: true,
		serverSide: true,
		ajax: '/backoffice/call/wizard/allowancegrid/get',
	...
	{	
		...
		if( id > 0 )	// Update
		{
			$('#createButton').hide();
			$('#updateButton').show();
			$('#addModalLabel').text("Update Allowance");
		...
		{
			$('#addModalLabel').text("Add Allowance");
			$('#createButton').show();
			$('#updateButton').hide();
		}		
	}
	...
	function onUpdateRow()
	{
		...
		if( id >= 0 )	// Update
		{
			$.ajax({
				type: "POST",
				url: "/backoffice/call/wizard/allowance/updatedata",
				data: data,
				success:function(data){
		...
		{	
			...
			$.ajax({
				type: "POST",
				url: "/backoffice/call/wizard/allowance/createdata",
				data: data,
				success:function(data){
					// $grid.fnDraw();
	...
	function  deleteRow()
	{
		...
		{
			$.ajax({
				url: "/backoffice/call/wizard/allowance/delete/" + id,
				success:function(data){					
					refreshCurrentPage();					
				},			
				error:function(request,status,error){
