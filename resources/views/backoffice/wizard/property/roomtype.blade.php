...
<?php
	...
	$current_url = '/backoffice/property/wizard/roomtype';
	$param = "";
...
<div class="item_container" style="margin:auto">
	...
	<div class="form_center">		
					...
					<tbody>
						...
						@foreach ( $datalist as $value )	
							<tr class="odd">
								...
								<td> {{$no}}</td>
								<td >
									<a href="{{$current_url}}/{{$value['id']}}/edit{{$param}}"><span>{{$value['type']}}</span></a>
								</td>		
								<td >
									{{$value->building->name}}
								</td>										
		...
		<div style="margin-top:20px;text-align:center">
			<div style="margin:auto; width:70%">
				<span class="delete-button"  style="float:left">
					...
					<input type="button" class="arrow-del-button" value="Delete" onclick="return resetForm(this.form);" />
				</span>
		...
		{{ Form::open(array('url' => '/backoffice/property/wizard/roomtype/' . $model->id, 'method' => $method )) }}		
			<div id="content_general" style="margin-top:30px;clear:both">
				<fieldset>
					...
					<div class="form-field">
						<label for="type" class="cm-required">Room Type:</label>
						<input type="text" id="type" name="type" class="input-text" size="32" maxlength="50" value="{{$model->type}}" />															
					</div>						
					<div class="form-field">
...
<div class="bottom-button" style="clear:both;">
	<span class="button-style cm-process-items" style="width:90%;text-align:right;margin:auto;margin-top:10px;">
		<input type="button" class="arrow-button" onclick="location.href = '/backoffice/property/wizard/floor';"  value="  Prev  " />
	</span>	&nbsp;&nbsp;&nbsp;&nbsp;
	<span class="button-style cm-process-items" style="width:90%;text-align:right;margin:auto;margin-top:10px;">
		<input type="button" class="arrow-button" onclick="location.href = '/backoffice/property/wizard/room';"  value="  Next  " />
	</span>						
</div>
