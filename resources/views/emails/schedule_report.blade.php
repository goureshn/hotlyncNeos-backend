  ...
  <div class="footer" >
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <div style="text-align:center; font-size: medium;" ><img src="http://www.ennovatech.ae/wp-content/uploads/2015/12/hotlync_c-300x49.png"><br/>
                  <br/><b>Hi {{$info['name']}},<br/>
                                Your Report {{$info['filename']}} is ready for download!</b></div>
                 </td>
                </tr>
                </table>
            </div>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                ...
                                <br /> 
                                <p>Please click <a href="{{$info['host_url']}}" download = "$filename">here</a> to download the report.</p>
                                </td>
                              </tr>
            </table>
                          </td>
