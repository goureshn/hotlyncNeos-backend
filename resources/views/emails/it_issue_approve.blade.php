        ...
        <td align="center" valign="top" id="bodyCell">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                                 ...
                                 <p>A New IT Issue has been Raised by <b>{{$info['raised_by']}}</b> which needs your approval.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                              <p>If you want to approve this request, please click the Approve button. If you want to reject it, please click the Reject button.</p>
							   </td>
                              </tr>
                            </table>
                          </td>
              ...
              <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButton">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                 <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}it/sendmaila?property_id={{$info['property_id']}}&status_id=1&&id={{$info['id']}}">
                                      Approve
                                  </a> 
                                </td>
                              </tr>
                          ...
                          <td align="center" valign="top" width="600" class="flexibleContainerCell bottomShim">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButtonrej">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                  <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}it/sendmaila?property_id={{$info['property_id']}}&status_id=6&&id={{$info['id']}}">
                                      Reject
                                  </a> 
