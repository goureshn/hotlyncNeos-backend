        ...
        <td align="center" valign="top" id="bodyCell">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                                 ...
                                 <p>Complaint for {{$info['ticket_info']}} has been flagged for a follow up by {{$info['by_name']}} </p>
                                </td>
                              </tr>
                            </table>
                          </td>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                              <p>Reminder: <b>{{$info['reminder_comment']}}</b></p>
							   </td>
                              </tr>
                            </table>
                          </td>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                              <p>Original Complaint: <b>{{$info['complaint_comment']}}</b></p>
							   </td>
                              </tr>
                            </table>
                          </td>
