...
<p>A new <b>{{$info['severity']}}</b> Sub-Complaint has been raised for the <b>{{$info['dept_name']}}</b> Department.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                        ...
                        <tr>
						  ...
						  <table align="Left" border="0" cellpadding="0" cellspacing="0" width="260" class="flexibleContainer">
                              <tr>
                                <td valign="top" class="textContent">
                                @if( $info['type'] == 'Rooms')
                                  <p><b>Location</b>: {{$info['location_name']}}</p>
                                  @else
                                  <p><b>Location</b>: {{$info['location_name']}} - {{$info['location_type']}}</p>
                                  @endif
                                  <p><b>Type</b>: {{$info['type']}}</p>
                                  <p><b>Guest</b>: {{$info['guest_name']}}</p>
                                   @if(!empty($info['arrival']))<p><b>Arrival</b>: {{$info['arrival']}}</p>@endif
                                  <p><b>Room</b>: {{$info['room']}}</p>
                                  @if(!empty($info['departments']))<p><b>Department</b>: {{$info['departments']}}</p>@endif 
                                  </td>
                              </tr>
                            </table>
                            <table align="Right" border="0" cellpadding="0" cellspacing="0" width="260" class="flexibleContainer">
                              <tr>
                                <td valign="top" class="textContentLast">
                                  ...
                                  @if(!empty($info['departure']))<p><b>Departure</b>: {{$info['departure']}}</p>@endif
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                               ...
                               <p><b>Intitial Response</b>: {{$info['initial_response']}}</p>
							   </td>
                              </tr>
                            </table>
                          </td>
