        ...
        <td align="center" valign="top" id="bodyCell">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                                 ...
                                 <p>There has been a change in status of the issue you've raised to: <b>{{$info['status']}}</b>.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
						  ...
						  <table align="Left" border="0" cellpadding="0" cellspacing="0" width="260" class="flexibleContainer">
                              <tr>
                                <td valign="top" class="textContent">
                                  ...
                                  <p>Updated By: <b>{{$info['updated_by']}}</b></p>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              ...
                              @if(!empty($info['ipcomment']) && $info['status'] != 'On-Hold')
              
                               <p>Comment: <b>{{$info['ipcomment']}}</b></p>
                               @endif
                                @if(!empty($info['resolution']) && $info['status'] == 'On-Hold')
              
                               <p>Hold Comment: <b>{{$info['resolution']}}</b></p>
                               @endif
							   </td>
                              </tr>
                            </table>
