             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                                 ...
                                 <p>A New Engineering Request has been Raised by <b>{{$info['raised_by']}}</b> which needs your approval.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButton">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                 <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}eng_mytask/sendmaila?property_id=4&status_id=1&&id={{$info['id']}}">
                Approve
            </a>
                                </td>
                              </tr>
                          ...
                          <td align="center" valign="top" width="600" class="flexibleContainerCell bottomShim">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButtonrej">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                  <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}eng_mytask/sendmaila?property_id=4&status_id=6&&id={{$info['id']}}">
                                    Reject
                                  </a>
                                </td>
                              </tr>
