          ...
          <table border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
            ...
            <tr>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                              <p>If you still have concerns regarding your issue, please click the Re-Open button. If your issue have been sorted, please click the Close button.</p>
							   </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButton">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                 <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}it/sendmail?property_id=3&status_id=5&&id={{$info['id']}}">
                Close
            </a>
                                </td>
                              </tr>
                          ...
                          <td align="center" valign="top" width="600" class="flexibleContainerCell bottomShim">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButtonrej">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                  <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}it/sendmail?property_id=4&status_id=4&&id={{$info['id']}}">
                Re-Open
            </a>
                                </td>
                              </tr>
