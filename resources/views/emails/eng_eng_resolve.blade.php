        ...
        <td align="center" valign="top" id="bodyCell">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                                 ...
                                 <p>The incident has been <b style="color:green;">Resolved</b> successfully by <b>{{$info['updated_by']}}</b>.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td valign="top" class="textContent">
                              <p>If you still have concerns regarding your engineering request, please click the Re-Open button. If your request have been completed, please click the Close button.</p>
							   </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButton">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                 <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}eng_mytask/sendmail?property_id=3&status_id=5&&id={{$info['id']}}">
                Close
            </a>
                                </td>
                              </tr>
                          ...
                          <td align="center" valign="top" width="600" class="flexibleContainerCell bottomShim">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="150" class="emailButtonrej">
                              <tr>
                                <td align="center" valign="middle" class="buttonContent">
                                  <a style="display: block;color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{$info['ip']}}eng_mytask/sendmail?property_id=4&status_id=4&&id={{$info['id']}}">
                Re-Open
            </a>
                                </td>
                              </tr>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                @if(!empty($info['comment']))
                               ...
                               <p>Comment: <b>{{$info['ipcomment']}}</b></p>
                 @endif
							   </td>
                              </tr>
                            </table>
